 ...
 */
package com.dy.audiodemo.io;

import android.os.Build;

import com.dy.audiodemo.io.stream.*;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.dy.audiodemo.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.dy.audiodemo.io.stream.ByteArrayOutputStream output = new com.dy.audiodemo.io.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * before using {@link com.dy.audiodemo.io.IOUtils#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see com.dy.audiodemo.io.IOUtils#toByteArray(InputStream, int)
     * @since 2.1
     */
